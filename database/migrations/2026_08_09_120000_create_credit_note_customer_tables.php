...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('credit_note_customer_items', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('credit_note_customer_items');
        Schema::dropIfExists('credit_note_customer');
    }
};
