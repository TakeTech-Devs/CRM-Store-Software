...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // "have I run this migration" state locally — so whichever store applies
        // this first creates these tables, and every other store re-running this
        // same migration must find them already there rather than fail. Guard
        // each create() the same way the column-additions below already do.
        if (!Schema::connection('remote_mysql')->hasTable('credit_note_customer')) {
        ...
        if (!Schema::connection('remote_mysql')->hasTable('credit_note_customer_items')) {
        ...
        if (!Schema::connection('remote_mysql')->hasTable('credit_note_staff')) {
        ...
        if (!Schema::connection('remote_mysql')->hasTable('credit_note_staff_items')) {
