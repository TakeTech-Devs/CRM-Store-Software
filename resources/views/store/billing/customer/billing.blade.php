        ...
        <div class="col-md-12 form-group d-flex align-items-start justify-content-between mb-0">
            ...
            <div class="d-flex align-items-start justify-content-around">
                <div class="form-group mx-3">
                    ...
                    <input type="text" class="form-control" id="searchBillingNumber" style="min-width:340px" placeholder="Bill no., phone or customer name">
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    // Matches bill number, customer phone or customer name across ALL loaded bills
    ...
    function applySearch() {
        ...
        filteredBills = !q ? allBills : allBills.filter(b =>
            [b.invoiceNo, b.customer_phone, b.customer_name]
